    ...
    <div>
      <div className="max-w-5xl mx-auto py-12 px-4 space-y-16">
        {programs.map((p) => (
          <div
            key={p.title}
            className={`flex flex-col ${p.side === 'right' ? 'md:flex-row' : 'md:flex-row-reverse'} gap-10 items-center`}
          >
            {/* Program image in orange circle */}
            ...
            <div className="flex-1">
              <h2 className="text-xl font-bold text-gray-800 mb-4 text-center md:text-left">{p.title}</h2>
